  	...
  	return(
  		...
  		<LineChart data={dataForDiagram}
	       ...
	       { Object.keys(this.props.suggestions).map((key, index) => {
	       	   return (<Line type="monotone" dataKey={ key } stroke={colors[key.toUpperCase()]} strokeWidth="3" key={ key } unit="%"/>)
	       }) }
      </LineChart>
      </ResponsiveContainer>
  	)
...
const colors = {
	ALC: '#616161', ENERC: '#212121', CHOAVL: '#651FFF', PROT: '#00E676', FAT: '#FF3D00',
	VITE: '#FFE0B2', VITD: '#FFCC80', VITK: '#FFB74D', CAROTENS: '#FFA726', VITA: '#FF9800', NIA: '#FB8C00', VITB12: '#F57C00', NIAEQ: '#EF6C00', VITPYRID: '#E65100', RIBF: '#FFD180', FOL: '#FFAB40', THIA: '#FF9100', VITC: '#FF6D00',
	ZN: '#00BFA5', FE: '#1DE9B6', ID: '#64FFDA', SE: '#A7FFEB', P: '#004D40', K: '#00695C', CA: '#00796B', MG: '#00897B', NA: '#009688', NACL: '#B2DFDB',
	FAPU: '#FFCCBC', F18D3N3: '#FFAB91', FAPUN3: '#FF8A65', F20D5N3: '#FF7043', FAPUN6: '#FF5722', F22D6N3: '#F4511E', FASAT: '#E64A19', FATRN: '#D84315', FAFRE: '#BF360C', FAMCIS: '#FF9E80', F18D2CN6: '#FF6E40', STERT: '#DD2C00', CHOLE: '#FBE9E7',
	FIBC: '#E1F5FE', FIBINS: '#B3E5FC', OA: '#81D4FA', SUGOH: '#4FC3F7', PSACNCS: '#29B6F6', FRUS: '#03A9F4', GALS: '#039BE5', SUCS: '#0288D1', GLUS: '#0277BD', SUGAR: '#01579B', LACS: '#80D8FF', MALS: '#40C4FF', STARCH: '#0091EA',
	TRP: '#E040FB'
}
